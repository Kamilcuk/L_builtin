...
function(generate_rust_bindings_and_version)
    ...
    add_custom_command(
        ...
        COMMAND "${L_BINDGEN_EXECUTABLE}"
            "${CMAKE_CURRENT_SOURCE_DIR}/l_builtin/c/l_builtins.h"
            --output "${L_GENERATED_RUST_BINDINGS}"
            ...
            --allowlist-function "l_run_with_unblocked"
            --allowlist-function "sh_invalidsig"
            --allowlist-function "signal_name"
            --allowlist-function "decode_signal"
            ...
            --allowlist-var "NO_SIG"
            --allowlist-var "NSIG"
            --allowlist-var "DSIG_NOCASE"
            --allowlist-var "DSIG_SIGPREFIX"
            ...
            "-I${bash_source}/lib"
        DEPENDS
            "${CMAKE_CURRENT_SOURCE_DIR}/l_builtin/c/l_bash_api.h"
            "${CMAKE_CURRENT_SOURCE_DIR}/l_builtin/c/l_builtins.h"
